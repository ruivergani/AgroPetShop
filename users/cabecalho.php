        ...
        <nav class="navbar navbar-inverse navbar-fixed-top navegacao" role="navigation">
            ...
            <div class="collapse navbar-collapse navbar-ex1-collapse">
                <ul class="nav navbar-nav side-nav">
                    ...
                    <li>
                      <a href="#" class="active" data-toggle="collapse" data-target="#submenu-3"><i class="fa fa-fw fa fa-users" aria-hidden="true"></i> Gerenciar Usuários <i class="fa fa-angle-down pull-right"></i></a>
                      <ul id="submenu-3" class="collapse">
                        <li><a href="add.php"><i class="fa fa-fw fa-user-plus"></i>Novo Usuário</a></li>
                        <li><a href="index.php"><i class="fa fa-fw fa-search"></i>Consultar Usuários</a></li>
                      </ul>
                    </li>

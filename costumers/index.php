...
?>
              ...
              <header>
                <div class="row">
                  <div class="col-xs-12 col-sm-8 col-md-8 col-lg-7">
                    <h2 class="titulo  col-sm-12 col-md-4 col-lg-4">Clientes</h2>
                    <hr class="visible-xs">
                  ...
                  <div class="text-right h2 button col-sm-4 col-md-4 col-lg-5" id="btntopo">
                    <a class="btn btn-primary" href="add.php"><i class="fa fa-fw fa-plus"></i><span class="hidden-sm"> Novo Cliente</span></a>
                    ...
                    <a class="btn btn-default" href="../ger_clientes.php"><i class="fa fa-fw fa fa-chevron-circle-left"></i><span class="hidden-xs hidden-sm hidden-md"> Voltar</span></a>
                  </div>
                </div>
              </header>
              ...
              <?php foreach ($customers as $customer) : ?>
                <tr>
                  ...
                  <td class="hidden-xs hidden-sm"><?php echo $customer['cpf_cnpj']; ?></td>
                  <td class="hidden-xs hidden-sm"><?php echo $customer['phone']; ?></td>
                  <td class="hidden-xs hidden-sm hidden-md">
                    <?php echo date('d/m/Y H:i:s', strtotime($customer['modified'])); ?>
                  </td>
                  <td class="actions text-left">
                    <a href="view.php?id=<?php echo $customer['id']; ?>" class="btn btn-sm btn-success"><i class="fa fa-eye"></i> <span class="hidden-xs">Visualizar</span></a>
                    <a href="edit.php?id=<?php echo $customer['id']; ?>" class="btn btn-sm btn-warning"><i class="fa fa-pencil"></i><span class="hidden-xs"> Editar </span></a>

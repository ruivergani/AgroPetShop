        ...
        <nav class="navbar navbar-inverse navbar-fixed-top navegacao" role="navigation">
            ...
            <div class="collapse navbar-collapse navbar-ex1-collapse">
                <ul class="nav navbar-nav side-nav">
                    ...
                    <li>
                      <a href="#" class="active" data-toggle="collapse" data-target="#submenu-5"><i class="fa fa-fw fa-address-book" aria-hidden="true"></i> Gerenciar Clientes <i class="fa fa-angle-down pull-right"></i> </a>
                      <ul id="submenu-5" class="collapse">
                        <li><a href="add.php"><i class="fa fa-fw fa-user-plus"></i>Novo Cliente</a></li>
                        <li><a href="index.php"><i class="fa fa-fw fa-search"></i>Consultar Clientes</a></li>
                      </ul>
                    </li>

                    <li>
                      <a href="#" data-toggle="collapse" data-target="#submenu-6"><i class="fa fa-fw fa-usd" aria-hidden="true"></i> Gerenciar Financeiro <i class="fa fa-angle-down pull-right"></i></a>

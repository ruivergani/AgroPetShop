        ...
        <nav class="navbar navbar-inverse navbar-fixed-top navegacao" role="navigation">
            ...
            <div class="collapse navbar-collapse navbar-ex1-collapse">
                <ul class="nav navbar-nav side-nav">
                    ...
                    <li>
                      <a href="#" class="active" data-toggle="collapse" data-target="#submenu-4"><i class="fa fa-fw fa-cubes" aria-hidden="true"></i> Gerenciar Produtos <i class="fa fa-angle-down pull-right"></i></a>
                      <ul id="submenu-4" class="collapse">
                        <li><a href="add.php"><i class="fa fa-fw fa-plus"></i>Novo Produto</a></li>
                        <li><a href="index.php"><i class="fa fa-fw fa-search"></i>Consultar Produtos</a></li>
                      </ul>
                    </li>

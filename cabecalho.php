  ...
  <body>
      ...
      <div id="wrapper">
        ...
        <nav class="navbar navbar-inverse navbar-fixed-top navegacao" role="navigation">
          ...
          <div class="navbar-header">
            ...
            <a class="navbar-brand text-center" <?php if($paginaCorrente == 'principal.php') {echo 'class="wow fadeIn"';} ?>  href="principal.php">
    ...
    <div class="collapse navbar-collapse navbar-ex1-collapse">
      <ul class="nav navbar-nav side-nav">
        ...
        <li <?php if($paginaCorrente == 'principal.php') {echo 'class="wow slideInUp"';} ?> data-wow-delay="0.1s">
          <a href="principal.php" <?php if($paginaCorrente == 'principal.php') {echo 'class="active"';} ?>><i class="fa fa-fw fa-home" aria-hidden="true" ></i> Início</a>
        </li>

        <li <?php if($paginaCorrente == 'principal.php') {echo 'class="wow slideInUp"';} ?>  data-wow-delay="0.2s">
          <a href="#" <?php if($paginaCorrente == 'ger_vendas.php') {echo 'class="active"';} ?> data-toggle="collapse" data-target="#submenu-1"><i class="fa fa-fw fa-shopping-cart" aria-hidden="true"></i> Realizar Venda <i class="fa fa-angle-down pull-right"></i></a>
        ...
        <li <?php if($paginaCorrente == 'principal.php') {echo 'class="wow slideInUp"';} ?>  data-wow-delay="0.3s">
          <a href="#" <?php if($paginaCorrente == 'ger_compras.php') {echo 'class="active"';} ?> data-toggle="collapse" data-target="#submenu-2"><i class="fa fa-fw fa fa-shopping-basket" aria-hidden="true"></i> Registrar Compra <i class="fa fa-angle-down pull-right"></i></a>
        ...
        <li <?php if($paginaCorrente == 'principal.php') {echo 'class="wow slideInUp"';} ?> data-wow-delay="0.4s">
          <a href="#" <?php if($paginaCorrente == 'ger_usuarios.php') {echo 'class="active"';} ?> data-toggle="collapse" data-target="#submenu-3"><i class="fa fa-fw fa fa-users" aria-hidden="true"></i> Gerenciar Usuários <i class="fa fa-angle-down pull-right"></i></a>
        ...
        <li <?php if($paginaCorrente == 'principal.php') {echo 'class="wow slideInUp"';} ?>  data-wow-delay="0.5s">
          <a href="#" <?php if($paginaCorrente == 'ger_produtos.php') {echo 'class="active"';} ?> data-toggle="collapse" data-target="#submenu-4"><i class="fa fa-fw fa-cubes" aria-hidden="true"></i> Gerenciar Produtos <i class="fa fa-angle-down pull-right"></i></a>
        ...
        <li <?php if($paginaCorrente == 'principal.php') {echo 'class="wow slideInUp"';} ?>  data-wow-delay="0.6s">
          <a href="#" <?php if($paginaCorrente == 'ger_clientes.php') {echo 'class="active"';} ?> data-toggle="collapse" data-target="#submenu-5"><i class="fa fa-fw fa-address-book" aria-hidden="true"></i> Gerenciar Clientes <i class="fa fa-angle-down pull-right"></i> </a>
        ...
        <li <?php if($paginaCorrente == 'principal.php') {echo 'class="wow slideInUp"';} ?>  data-wow-delay="0.7s">
          <a href="#" <?php if($paginaCorrente == 'ger_financeiro.php') {echo 'class="active"';} ?> data-toggle="collapse" data-target="#submenu-6"><i class="fa fa-fw fa-usd" aria-hidden="true"></i> Gerenciar Financeiro <i class="fa fa-angle-down pull-right"></i></a>
          <ul id="submenu-6" class="collapse">
            <li><a href="financials/index.php"><i class="fa fa-fw fa-percent"></i>Fluxo de Caixa</a></li>
          </ul>
        </li>

        <li <?php if($paginaCorrente == 'principal.php') {echo 'class="wow slideInUp"';} ?>  data-wow-delay="0.8s">
          <a href="#" <?php if($paginaCorrente == 'ger_relatorios.php') {echo 'class="active"';} ?> data-toggle="collapse" data-target="#submenu-7" ><i class="fa fa-fw fa-bar-chart" aria-hidden="true"></i> Emitir Relatórios <i class="fa fa-angle-down pull-right"></i></a>
        ...
        <li <?php if($paginaCorrente == 'principal.php') {echo 'class="wow slideInUp"';} ?>  data-wow-delay="0.9s">
          <a href="#" <?php if($paginaCorrente == 'ger_fornecedor.php') {echo 'class="active"';} ?> data-toggle="collapse" data-target="#submenu-8" ><i class="fa fa-fw fa-truck" aria-hidden="true"></i> Gerenciar Fornecedor<i class="fa fa-angle-down pull-right"></i></a>
        ...
        <li <?php if($paginaCorrente == 'principal.php') {echo 'class="wow slideInUp"';} ?>  data-wow-delay="1s">
          <a href="#" <?php if($paginaCorrente == 'ger_servico.php') {echo 'class="active"';} ?> data-toggle="collapse" data-target="#submenu-9"><i class="fa fa-fw fa-wrench" aria-hidden="true"></i> Gerenciar Serviços <i class="fa fa-angle-down pull-right"></i></a>

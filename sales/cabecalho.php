        ...
        <nav class="navbar navbar-inverse navbar-fixed-top navegacao" role="navigation">
            ...
            <div class="collapse navbar-collapse navbar-ex1-collapse">
                <ul class="nav navbar-nav side-nav">
                    ...
                    <li>
                      <a href="#"  class="active" data-toggle="collapse" data-target="#submenu-1"><i class="fa fa-fw fa-shopping-cart" aria-hidden="true"></i> Realizar Venda <i class="fa fa-angle-down pull-right"></i></a>
                      <ul id="submenu-1" class="collapse">
                        <li><a href="add.php"><i class="fa fa-fw fa fa-money"></i>Nova Venda</a></li>
                        <li><a href="index.php"><i class="fa fa-fw fa-search"></i>Consultar Vendas</a></li>
                      </ul>
                    </li>
